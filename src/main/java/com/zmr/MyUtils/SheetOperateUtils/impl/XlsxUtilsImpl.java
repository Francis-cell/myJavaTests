package com.zmr.MyUtils.SheetOperateUtils.impl;
...
@Component
public class XlsxUtilsImpl implements XlsxUtils {
    private static final XlsxUtilsImpl INSTANCE = new XlsxUtilsImpl();

    private XlsxUtilsImpl() {}

    public static XlsxUtilsImpl getInstance() {
        return INSTANCE;
    }
    ...
    @Override
    public Object[][] readXlsxFile(String path) {
        return readXlsxFile(path, SHEET_INDEX);
    }

    @Override
    public Object[][] readXlsxFile(String path, int sheetIndex) {
     ...
     */
    @Override
    public void printXlsxFile(String path) {
     ...
     */
    @Override
    public void printXlsxFile(String path, int sheetIndex) {
     ...
     */
    @Override
    public Map getXlsxFileRowAndColumnCount(String path) {
     ...
     */
    @Override
    public Map getXlsxFileRowAndColumnCount(String path, int sheetIndex) {
     ...
     */
    @Override
    public void writeDataToAXlsxFile(String path, String xlsxFileName, Object[][] data) {
