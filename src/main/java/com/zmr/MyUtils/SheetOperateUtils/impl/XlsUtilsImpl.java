...
@Component
public class XlsUtilsImpl implements XlsUtils {
    private static final XlsUtilsImpl INSTANCE = new XlsUtilsImpl();

    private XlsUtilsImpl() {}

    public static XlsUtilsImpl getInstance() {
        return INSTANCE;
    }
     ...
     */
    @Override
    public Object[][] readXlsFile(String path) {
     ...
     */
    @Override
    public Object[][] readXlsFile(String path, int sheetIndex) {
     ...
     */
    @Override
    public void printXlsFile(String path) {
     ...
     */
    @Override
    public void printXlsFile(String path, int sheetIndex) {
        // 使用 HSSFWorkbook 操作 .xls 文件
        try (Workbook workbookXls = new HSSFWorkbook(new FileInputStream(path))) {
            Sheet sheet = workbookXls.getSheetAt(sheetIndex);
            // 获取当前的 xls 文件中的行数和列数信息
     ...
     */
    @Override
    public Map getXlsFileRowAndColumnCount(String path) {
     ...
     */
    @Override
    public Map getXlsFileRowAndColumnCount(String path, int sheetIndex) {
     ...
     */
    @Override
    public void writeDataToAXlsFile(String path, String xlsFileName, Object[][] data) {
