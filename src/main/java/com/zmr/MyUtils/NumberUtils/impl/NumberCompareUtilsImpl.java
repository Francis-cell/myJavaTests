...
import com.zmr.MyUtils.NumberUtils.NumberCompareUtils;
import org.springframework.stereotype.Component;

import java.math.BigDecimal;

@Component
public class NumberCompareUtilsImpl implements NumberCompareUtils {
    private static final NumberCompareUtilsImpl INSTANCE = new NumberCompareUtilsImpl();

    private NumberCompareUtilsImpl() {}

    public NumberCompareUtilsImpl getInstance() {
        return INSTANCE;
    }
     ...
     */
    @Override
    public boolean checkSomePercentBetweenTwoNum(String num1, String num2, int percent) {
     ...
     */
    private boolean isWithinNPercent(double num1, double num2, int percent,Double baseNum) {
        // 转换成 BigDecimal 进行计算
