package com.zmr.LearningFiles.OwnLearning.UtilsUsing.utils.arithmeticUtils;
...
public class ArithmeticUtils {
    ...
    /**
     * 提供精确的乘法运算(保留scale位小数，并进行四舍五入处理)【对结果进行处理】
     *
     * @param v1    被乘数
     * @param v2    乘数
     * @param scale 保留scale 位小数
